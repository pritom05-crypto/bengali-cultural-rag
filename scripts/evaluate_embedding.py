...
print("=" * 75)
print("BENGALI CULTURAL RAG - RETRIEVAL BENCHMARK")
print("=" * 75)
...
print("\nEncoding 404 cultural expressions...")
...
for idx, test in enumerate(TEST_QUERIES, start=1):
    ...
    for rank, phrase in enumerate(
        [phrases[i] for i in ranked_indices],
        start=1
    ):
    ...
    for rank, (phrase, score) in enumerate(
        top5,
        start=1
    ):
        marker = "✓" if phrase in expected else " "
